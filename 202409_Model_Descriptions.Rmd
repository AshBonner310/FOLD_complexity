...
#creates the inputs function we will be using, so we can graph the inputs against the model simulations.
...
#params
Params_OnePool.ls <- list(const_inputs = 260, #g-C m-2 yr-1
...
SS_OnePool.fn <- function(parms){
  ...
  return(c(Cumulative_Respiration = 0, Soil_Carbon_Concentration = ans))
}
