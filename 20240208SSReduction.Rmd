...
grViz("
  digraph Three_Pool_Model {
    ...
    Inputs  -> Slow     [headport=w, color = green3]; 
    Inputs  -> Passive  [headport=w, color = blue3];
    Fast    -> CarbonDioxide [tailport=n, color = red3]; 
    Slow    -> CarbonDioxide [tailport=n, color=green3]; 
    Passive -> CarbonDioxide [tailport=n, color=blue3]
      ...
      subgraph cluster_SoilPools {
        ...
        Fast[color=red3, fontcolor=red4]; Slow[color=green3, fontcolor=green4]; Passive[color=blue3, fontcolor=blue4]
        
        #Fluxes out of Fast
        Fast -> Slow[tailport=n, color = red]
        Fast -> Passive[tailport=n, color = red]
        
        #Fluxes out of Slow
        Fast -> Slow [dir=back, color = green, headport = n]
        Slow -> Passive[tailport=n, color = green]
        
        #Fluxes out of Passive
        Fast -> Passive[dir=back, color=blue, headport = n]
        Slow -> Passive[dir=back, color=blue, headport = n]
      }
    }
  }
")
...
#initial value
InitialCarbon_3pool <- SS_Century(parms = century_parameter.ls)*0.75
...
SS_Century5 <- function(parms){
  ...
  decay_matrix <- diag(x= 1/c(parms$turnoverTime_meta,
                             ...
                             parms$turnoverTime_slow,
                             parms$turnoverTime_passive))
  transfer_matrix <- matrix(c(1, -parms$struc_to_meta, -parms$fast_to_meta, -parms$slow_to_meta, -parms$passive_to_meta,
